                            ...
                            <div className="grid gap-6">
                                {sections.map((section, idx) => (
                                    <motion.div
                                        ...
                                        className="p-5 rounded-3xl bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5 transition-all hover:border-emerald-500/30"
                                    >
                                        <h3 className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-wider mb-1">{section.title}</h3>
