        ...
        <AnimatePresence>
            {(loading || selectedUserDetails) && (
                <motion.div
                    ...
                    className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-md p-6 sm:p-6"
                    onClick={onClose}
                >
                    <AnimatePresence mode="wait">
                        {loading ? (
                            ...
                            >
                                <Card
                                    className="border-2 border-[var(--color-divider)] rounded-[3rem] overflow-hidden shadow-2xl bg-[var(--color-bg-card)] flex flex-col items-center justify-center p-12 text-center relative gap-6"
                                >
                            ...
                            selectedUserDetails && (
                                <motion.div
                                    ...
                                    onClick={(e) => e.stopPropagation()}
                                    className="max-w-md w-full h-[100dvh] sm:h-auto sm:max-h-[90vh] flex flex-col"
                                >
                                    <Card
                                        className="w-full h-full border-0 sm:border-2 border-[var(--color-divider)] rounded-none sm:rounded-[2rem] overflow-hidden shadow-none sm:shadow-2xl bg-[var(--color-bg-card)] flex flex-col relative"
                                    >
                                            ...
                                            {selectedUserDetails.role === 'nutritionist' && selectedUserDetails.license_image_url && (
                                                <div className="p-4 bg-[var(--color-bg-page)] rounded-2xl border border-[var(--color-divider)]">
                                                    ...
                                                    <div className="flex items-center gap-3.5">
                                                        ...
                                                        >
                                                            <img src={selectedUserDetails.license_image_url} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" alt="" />
