    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500 pb-20">
            ...
            <div className="relative overflow-hidden rounded-3xl border-2 border-[var(--color-divider)] shadow-xl bg-[var(--color-bg-card)]">
                ...
                <div className="relative p-6 sm:p-8 flex flex-col sm:flex-row items-center sm:items-end gap-6">
                    {/* Avatar */}
                    <div className="relative flex-shrink-0 group">
                        <div className="h-24 w-24 overflow-hidden bg-white/20 backdrop-blur-sm rounded-3xl border-2 border-white/40 flex items-center justify-center text-white text-3xl font-black shadow-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="bg-white dark:bg-white/5 border-2 border-[var(--color-divider)] shadow-sm rounded-3xl overflow-hidden hover:shadow-md transition-all group">
                    <CardContent className="p-6 flex items-center gap-4">
                        <div className="h-12 w-12 bg-blue-100 dark:bg-blue-900/20 rounded-2xl flex items-center justify-center text-blue-600 dark:text-blue-400 transition-transform group-hover:scale-110">
                            <Users size={24} />
                        </div>
                        <div>
                            <p className="text-[10px] font-black text-[var(--color-text-muted)] uppercase tracking-widest">Active Clients</p>
                            <h2 className="text-3xl font-black text-[var(--color-text-main)] mt-0.5">{stats.clients}</h2>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="bg-white dark:bg-white/5 border-2 border-[var(--color-divider)] shadow-sm rounded-3xl overflow-hidden hover:shadow-md transition-all group">
                    <CardContent className="p-6 flex items-center gap-4">
                        <div className="h-12 w-12 bg-orange-100 dark:bg-orange-900/20 rounded-2xl flex items-center justify-center text-orange-600 dark:text-orange-400 transition-transform group-hover:scale-110">
                            <ClipboardList size={24} />
                        </div>
                        <div>
                            <p className="text-[10px] font-black text-[var(--color-text-muted)] uppercase tracking-widest">Pending Reviews</p>
                            <h2 className="text-3xl font-black text-[var(--color-text-main)] mt-0.5">{stats.pending}</h2>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="bg-white dark:bg-white/5 border-2 border-[var(--color-divider)] shadow-sm rounded-3xl overflow-hidden hover:shadow-md transition-all group">
                    <CardContent className="p-6 flex items-center gap-4">
                        <div className="h-12 w-12 bg-emerald-100 dark:bg-emerald-900/20 rounded-2xl flex items-center justify-center text-emerald-600 dark:text-emerald-400 transition-transform group-hover:scale-110">
                            <Activity size={24} />
                        </div>
                        <div>
                            <p className="text-[10px] font-black text-[var(--color-text-muted)] uppercase tracking-widest">Daily Success</p>
                            <h2 className="text-3xl font-black text-[var(--color-text-main)] mt-0.5">85%</h2>
                        </div>
                    </CardContent>
                </Card>
            </div>
