...
export default function Login() {
    ...
    return (
        <div className="min-h-[100dvh] w-full flex items-center justify-center bg-gray-50 dark:bg-[var(--color-bg-page)] sm:p-4 transition-colors duration-300 overflow-y-auto">
            <Card className="w-full sm:max-w-md shadow-2xl border-0 dark:border dark:border-[var(--color-divider)] rounded-none sm:rounded-[2.5rem] overflow-y-auto sm:overflow-hidden min-h-[100dvh] sm:min-h-0 flex flex-col justify-center">
